...
public class CheckandDelete extends IntentService {
	...
	private void postData() throws JSONException {
		Log.d("CheckandDelete", "PostData() being called");
		// Create a new HttpClient and Post Header
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost(
				"http://www.georgemourton.com/checkanddelete.php");
		...
		try {
			...
			if (response != null) {
				...
				Log.d("CheckandDelete", serverResponse);
			}
			...
			Log.w("CheckandDelete", e.getMessage());
		}
	}
